...
interface Props {
  ...
  name: string;
  condition: string;
  setWeather: (query: string) => Promise<void>;
}
...
export default function Weather({ temp, name, condition, setWeather }: Props) {
      ...
      <View style={{ ...styles.container, ...styles.textContainer }}>
        ...
        <View style={styles.searchContainer}>
          ...
          <View style={styles.btn}>
            <Button title="Search" onPress={() => setWeather(query)} />
          </View>
        </View>
      </View>
    </LinearGradient>
